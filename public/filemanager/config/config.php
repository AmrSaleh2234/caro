...
$config = array(
	...
	*/
	...
	'ext_file'                                => array( 'epub' ,'doc', 'docx', 'rtf', 'pdf', 'xls', 'xlsx', 'txt', 'csv', 'html', 'xhtml', 'psd', 'sql', 'log', 'fla', 'xml', 'ade', 'adp', 'mdb', 'accdb', 'ppt', 'pptx', 'odt', 'ots', 'ott', 'odb', 'odg', 'otp', 'otg', 'odf', 'ods', 'odp', 'css', 'ai', 'kmz','dwg', 'dxf', 'hpgl', 'plt', 'spl', 'step', 'stp', 'iges', 'igs', 'sat', 'cgm', 'tiff',''), //Files
	...
	*******************/
	...
	'hidden_folders'                          => array('thumbs','files'),
	...
	*******************/
	...
	'fixed_path_from_filemanager'             => array( './thumbs', './thumbs'), //fixed path of the image folder from the current position on upload folder
	'fixed_image_creation_name_to_prepend'    => array( '' , '' , ''), //name to prepend on filename
	'fixed_image_creation_to_append'          => array( '-w-500-h-500', '-w-100-h-100'), //name to appendon filename
	'fixed_image_creation_width'              => array( 500, 100 ), //width of image
	'fixed_image_creation_height'             => array( 500, 100 ), //height of image
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
	...
	*/
	...
	'relative_image_creation_name_to_append'  => array( '-w-500-h-500', '-w-100-h-100'), //name to append on filename
	'relative_image_creation_width'           => array( 500, 100 ), //width of image
	'relative_image_creation_height'          => array( 500, 100), //height of image
	/*
	#             $option:     0 / exact = defined size;
	#                          1 / portrait = keep aspect set height;
	#                          2 / landscape = keep aspect set width;
