...
if (USE_ACCESS_KEYS == TRUE){
    ...
    if($_GET['akey'] !='admin_panel'){
        $config['hidden_folders'] =array('clients','projects','masterplans','units','buildings','contracts');
    }
        // if($_GET['akey'] !='admin_panel'){
        // $config['delete_files'] = $config['create_folders'] = $config['delete_folders'] = $config['rename_files'] = $config['rename_folders'] = false;
	    // $config['duplicate_files'] = $config['copy_cut_files'] = $config['copy_cut_dirs'] = $config['chmod_files'] = $config['chmod_dirs'] = false;
	    // $config['preview_text_files'] = $config['edit_text_files'] =$config['create_text_files'] = $config['download_files'] =$config['show_sorting_bar'] = $config['show_filter_buttons'] =  false;
        // $config['ext_img'] = $config['ext_file'] = $config['ext_video'] = $config['ext_music'] = $config['ext_misc'] =  array();
        // }
}
